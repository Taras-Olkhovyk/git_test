...
Revision ID: b6bb9f06fb58
Revises: 
Create Date: 2022-06-07 20:51:55.506558
...
def upgrade():
    ...
    sa.Column('email', sa.String(length=1020), nullable=False),
...
def downgrade():
    ...
    sa.Column('email', sa.VARCHAR(length=1020), nullable=False),
    sa.Column('image_file', sa.VARCHAR(length=60), nullable=False),
